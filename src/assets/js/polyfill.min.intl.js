...
(function(undefined) {
    !function(e, r) {
        ...
        function r(e) {
            for (var t in e)
                (e instanceof r || re.call(e, t)) && te(this, t, {
                    value: e[t],
                    enumerable: !0,
                    writable: !0,
                    configurable: !0
        ...
        function c(e) {
            ...
            for (var i = 1, s = t.length; s > i; i++)
                re.call(Oe.subtags, t[i]) ? t[i] = Oe.subtags[t[i]] : re.call(Oe.extLang, t[i]) && (t[i] = Oe.extLang[t[i]][0], 1 === i && Oe.extLang[t[1]][1] === t[0] && (t = ie.call(t, i++), s -= 1));
            return le.call(t, "-")
        }
        function u() {
            return Ee
        ...
        function m(e) {
            ...
            for (var n = a(e), i = n.length, s = 0; i > s;) {
                ...
                if (u) {
                    var g = n[o];
                    if (null === g || "string" != typeof g && "object" !== ("undefined" == typeof g ? "undefined" : J["typeof"](g)))
                        throw new TypeError("String or Object type expected");
                    var m = String(g);
                    if (!l(m))
                        throw new RangeError("'" + m + "' is not a structurally valid language tag");
        ...
        function v(e, t) {
            for (var n = 0, a = t.length, i = void 0, s = void 0, o = void 0; a > n && !i;)
                s = t[n], o = String(s).replace(Te, ""), i = f(e, o), n++;
            var l = new r;
            if (void 0 !== i) {
        ...
        function b(e, t, n) {
            var i = void 0,
                s = void 0;
            if (void 0 !== n && (n = new r(a(n)), i = n.localeMatcher, void 0 !== i && (i = String(i), "lookup" !== i && "best fit" !== i)))
        ...
        function w(e, r, t, n, a) {
            var i = e[r];
            if (void 0 !== i) {
                if (i = "boolean" === t ? Boolean(i) : "string" === t ? String(i) : i, void 0 !== n && -1 === ne.call(n, i))
        ...
        function z(e, s, o) {
            ...
            if (void 0 !== x && !g(x))
                throw new RangeError("'" + x + "' is not a valid currency code");
            if ("currency" === b && void 0 === x)
                        ...
                        if (D > 0 ? (b = y.substring(0, D), w = y.substring(D + 1, D.length)) : (b = y, w = void 0), n["[[useGrouping]]"] === !0) {
                            ...
                            if (b.length > k) {
                                var j = b.length - k,
                                    S = j % F,
                                    N = b.slice(0, S);
                                for (N.length && oe.call(z, N); j > S;)
                                    oe.call(z, b.slice(S, S + F)), S += F;
                                oe.call(z, b.slice(j))
                            } else
                                oe.call(z, b);
                            if (0 === z.length)
        ...
        function E(r, t, n) {
            ...
            if (s >= a)
                return i + le.call(Array(s - a + 1 + 1), "0");
            if (s === a - 1)
                return i;
        ...
        function L(e) {
            for (var r = 0; r < Ge.length; r += 1)
                if (e.hasOwnProperty(Ge[r]))
                    return !1;
            return !0
        }
        function T(e) {
            for (var r = 0; r < Ae.length; r += 1)
                if (e.hasOwnProperty(Ae[r]))
                    return !1;
            return !0
        }
        function P(e, r) {
            for (var t = {
                ...
                e[Ae[n]] && (t[Ae[n]] = e[Ae[n]]), e._[Ae[n]] && (t._[Ae[n]] = e._[Ae[n]]);
            for (var a = 0; a < Ge.length; a += 1)
                r[Ge[a]] && (t[Ge[a]] = r[Ge[a]]), r._[Ge[a]] && (t._[Ge[a]] = r._[Ge[a]]);
            return t
        }
        function _(e) {
        ...
        function q(e) {
            var r = e.availableFormats,
                ...
                g = [];
            for (i in r)
                r.hasOwnProperty(i) && (s = r[i], o = M(i, s), o && (a.push(o), L(o) ? g.push(o) : T(o) && u.push(o)));
            for (i in t)
                t.hasOwnProperty(i) && (s = t[i], o = M(i, s), o && (a.push(o), u.push(o)));
            for (i in n)
                n.hasOwnProperty(i) && (s = n[i], o = M(i, s), o && (a.push(o), g.push(o)));
            for (l = 0; l < u.length; l += 1)
                for (c = 0; c < g.length; c += 1)
                    s = "long" === g[c].month ? g[c].weekday ? e.full : e["long"] : "short" === g[c].month ? e.medium : e["short"], o = P(g[c], u[l]), o.originalPattern = s, o.extendedPattern = s.replace("{0}", u[l].extendedPattern).replace("{1}", g[c].extendedPattern).replace(/^[,\s]+|[,\s]+$/gi, ""), a.push(_(o));
            return a
        }
        ...
        function G(e, a, s) {
            ...
            var z = void 0,
                k = h[y],
                F = C(k.formats);
            if (f = w(s, "formatMatcher", "string", new t("basic", "best fit"), "best fit"), k.formats = F, "basic" === f)
                z = B(g, F);
            else {
        ...
        function $(e, r) {
            ...
            for (var i = a["[[locale]]"], s = new Pe.NumberFormat([i], {
                ...
                if (Ze.hasOwnProperty(y)) {
                    var b = a["[[" + y + "]]"],
                        w = l["[[" + y + "]]"];
                    if ("year" === y && 0 >= w ? w = 1 - w : "month" === y ? w++ : "hour" === y && a["[[hour12]]"] === !0 && (w %= 12, 0 === w && a["[[hourNo0]]"] === !0 && (w = 12)), "numeric" === b)
                        p = N(s, w);
                    else if ("2-digit" === b)
                        p = N(o, w), p.length > 2 && (p = p.slice(-2));
                    else if (b in Ce)
                        switch (y) {
                        case "month":
        ...
        function W(e, r) {
            ...
            var t = void 0,
                n = [r],
                a = r.split("-");
            for (a.length > 2 && 4 === a[1].length && oe.call(n, a[0] + "-" + a[2]); t = ce.call(n);)
                oe.call(ge.NumberFormat["[[availableLocales]]"], t), ge.NumberFormat["[[localeData]]"][t] = e.number, e.date && (e.date.nu = e.number.nu, oe.call(ge.DateTimeFormat["[[availableLocales]]"], t), ge.DateTimeFormat["[[localeData]]"][t] = e.date);
            void 0 === Ee && s(r)
        }
        var J = {};
        ...
        te(Pe, "NumberFormat", {
            ...
            value: ue.call(function(e) {
                if (!re.call(this, "[[availableLocales]]"))
        ...
        if (Be.Number.toLocaleString = function() {
            ...
            value: function() {
                ...
                for (var e in Be.Date)
                    re.call(Be.Date, e) && te(Date.prototype, e, {
                        writable: !0,
                        configurable: !0,
                        value: Be.Date[e]
                    })
